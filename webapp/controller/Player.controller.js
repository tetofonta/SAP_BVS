	...
	return Controller.extend("BVS.controller.Player", {
		...
		_onRouteMatched : function (oEvent) {
				...
				if (oQuery)
					...
					this.getView().byId('profilePic').setSrc(getFromApi(getPlayer, {NUMERO: numeroPlayer, SQUADRA: squadraPlayer})[0].foto);
					this.getView().byId('nomecognomeField').setValue(getFromApi(getPlayer, {NUMERO: numeroPlayer, SQUADRA: squadraPlayer})[0].nome);
					this.getView().byId('numeroField').setValue(getFromApi(getPlayer, {NUMERO: numeroPlayer, SQUADRA: squadraPlayer})[0].numero);
					this.getView().byId('datanascitaField').setValue(getFromApi(getPlayer, {NUMERO: numeroPlayer, SQUADRA: squadraPlayer})[0].data_di_nascita);
		}
